...
function TermsConditionsBox() {
    ...
    return (
    <Accordion sx={{maxHeight: '200px', overflowY: 'scroll'}} expanded>
      <AccordionSummary expandIcon={<ExpandMoreIcon />}>
        <Typography>Propass Terms & Conditions</Typography>
        
      </AccordionSummary>
      <Box sx={{p: 2}}>
        
        <Typography>
        Terms and Conditions for ProPass Introduction: These Website
        ...
        old are not allowed to use this Website. Intellectual Property Rights
        ...
        purposes of viewing the material contained on this Website. Restrictions
        ...
        Your Content from this Website at any time without notice. No warranties
        ...
        Limitation of liability In no event shall Company Name, nor any of its
        ...
        whether such liability is under contract. Company Name, including its
        ...
        way related to your use of this Website. Indemnification You hereby
        indemnify to the fullest extent Company Name from and against any and/or
        ...
        these Terms. Severability If any provision of these Terms is found to be
        invalid under any applicable law, such provisions shall be deleted
        without affecting the remaining provisions herein. Variation of Terms
        ...
        a regular basis. Assignment The Company Name is allowed to assign,
        ...
        agreement between Company Name and you in relation to your use of this
        ...
        interpreted in accordance with the laws of the State of Country, and you
